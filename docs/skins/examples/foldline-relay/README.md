...
thumbconsole skin validate build/foldline-relay-1.0.0.pocketpad --strict
thumbconsole skin quality . --artboard productivity-one-handed-left-v1 --strict
