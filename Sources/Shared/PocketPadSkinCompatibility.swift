...
public enum PocketPadSkinCompatibilityMode: String, Codable, CaseIterable, Identifiable, Sendable {
    case universal
...
public struct PocketPadSkinTemplateRequirement: Codable, Equatable, Sendable {
...
public enum PocketPadSkinRenderingFeature: String, Codable, CaseIterable, Identifiable, Sendable {
...
public struct PocketPadSkinCompatibility: Codable, Equatable, Sendable {
    public var mode: PocketPadSkinCompatibilityMode
    public var templates: [PocketPadSkinTemplateRequirement]
    ...
    public var requiredFeatures: [PocketPadSkinRenderingFeature]

    public init(
        mode: PocketPadSkinCompatibilityMode = .universal,
        templates: [PocketPadSkinTemplateRequirement] = [],
        orientations: [PocketPadSkinOrientation] = PocketPadSkinOrientation.allCases,
        minimumAspectRatio: CGFloat? = nil,
        maximumAspectRatio: CGFloat? = nil,
        requiredRoles: [GamepadVisualRole] = [],
        requiredFeatures: [PocketPadSkinRenderingFeature] = []
    ) {
        self.mode = mode
    ...
    public var normalized: PocketPadSkinCompatibility {
        ...
        return PocketPadSkinCompatibility(
            mode: mode,
            templates: templates,
...
public enum PocketPadSkinCompatibilityStatus: String, Codable, Equatable, Sendable {
    case compatible
    case degraded
    case incompatible
}

public struct PocketPadSkinCompatibilityIssue: Codable, Equatable, Sendable {
...
public struct PocketPadSkinCompatibilityEvaluation: Codable, Equatable, Sendable {
    public var status: PocketPadSkinCompatibilityStatus
    public var issues: [PocketPadSkinCompatibilityIssue]

    public init(status: PocketPadSkinCompatibilityStatus, issues: [PocketPadSkinCompatibilityIssue] = []) {
        self.status = status
        self.issues = issues
    }
...
public enum PocketPadSkinCompatibilityEvaluator {
    public static let supportedFeatures = Set(PocketPadSkinRenderingFeature.allCases)

    public static func evaluate(
        _ compatibility: PocketPadSkinCompatibility?,
        customization: GamepadCustomization,
        orientation: PocketPadSkinOrientation
    ) -> PocketPadSkinCompatibilityEvaluation {
        guard let compatibility else { return .init(status: .compatible) }
        let value = compatibility.normalized
        var issues: [PocketPadSkinCompatibilityIssue] = []
