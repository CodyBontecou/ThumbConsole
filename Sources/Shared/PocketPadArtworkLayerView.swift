...
struct GamepadArtworkLayersView: View {
    let layers: [PocketPadSkinArtworkLayer]
    let plane: PocketPadSkinArtworkPlane
        ...
        GeometryReader { proxy in
            ...
            ZStack {
                ForEach(visible) { layer in
                    let frame = layer.frame ?? PocketPadNormalizedRect(x: 0, y: 0, width: 1, height: 1)
...
private extension PocketPadSkinArtworkBlendMode {
