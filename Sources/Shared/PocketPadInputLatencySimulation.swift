...
public enum PocketPadLatencySimulationPattern: String, Codable, CaseIterable, Sendable {
...
public enum PocketPadLatencySimulationMode: String, Codable, CaseIterable, Sendable {
    case current
...
public struct PocketPadLatencySimulationReport: Codable, Sendable {
    public var pattern: PocketPadLatencySimulationPattern
    public var mode: PocketPadLatencySimulationMode
    public var assumptions: [String: Double]
    public var summary: PocketPadLatencySimulationSummary
    public var samples: [PocketPadLatencySimulationSample]
...
public struct PocketPadLatencyVerificationReport: Codable, Sendable {
    public var passed: Bool
    public var maxAllowedMilliseconds: Double
    public var p95AllowedMilliseconds: Double
    public var reports: [PocketPadLatencySimulationReport]
    public var failures: [String]
}

public struct PocketPadLatencySimulationSummary: Codable, Sendable {
...
public struct PocketPadLatencySimulationSample: Codable, Sendable {
...
public enum PocketPadInputLatencySimulator {
    public static func run(
        pattern: PocketPadLatencySimulationPattern = .hollowKnight,
        mode: PocketPadLatencySimulationMode = .current
    ) -> PocketPadLatencySimulationReport {
        var simulator = Simulation(pattern: pattern, mode: mode)
        return simulator.run()
    }

    public static func verifyCurrentPath(
        patterns: [PocketPadLatencySimulationPattern] = [
            .hollowKnight,
            .sameButtonBurst,
            .udpRecovery,
            .udpRecoveryBurst,
    ...
    ) -> PocketPadLatencyVerificationReport {
        ...
        return PocketPadLatencyVerificationReport(
...
private struct Simulation {
    ...
    private struct MutableSample {
        ...
        var output: PocketPadLatencySimulationSample {
            let latency = injectedAt.map { $0 >= touchAt ? $0 - touchAt : 0 }
            return PocketPadLatencySimulationSample(
    ...
    init(pattern: PocketPadLatencySimulationPattern, mode: PocketPadLatencySimulationMode) {
        self.pattern = pattern
        self.mode = mode
    }

    mutating func run() -> PocketPadLatencySimulationReport {
        ...
        let summary = PocketPadLatencySimulationSummary(
        ...
        return PocketPadLatencySimulationReport(
            pattern: pattern,
            mode: mode,
