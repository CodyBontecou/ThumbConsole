...
**Eyebrow:** Mac + iPhone / one controller
**Headline:** Turn your iPhone into a custom gaming controller.
**Support:** Build a layout for the game. Shape every control. Keep it in your pocket.

Visual: Hollow Knight controller rises into frame inside a landscape phone treatment.
...
**Eyebrow:** Your layout, in your hands
**Headline:** Built for multitouch. Tuned for the game.

Visual: Landscape iPhone controller with real button press footage. Supporting tags: 15 controls, Landscape, Multitouch, Pressed states, Haptics.

### 0:27–0:36 — Customization

**Eyebrow:** Freeform by design
**Headline:** Move it. Resize it. Make it yours.

Visual: Real iOS Simulator edit mode unlocks. The Soul button is dragged, selected, and enlarged. The visible rotate handle supports the “Drag / Scale / Rotate” callout.

### 0:35–0:41 — Sync

**Eyebrow:** One local connection
**Headline:** Designed on Mac. Synced to iPhone.

Visual: Tart VM Mac helper and iPhone controller side by side, joined by an animated connection line. Tags: Local network, Authenticated, Low latency, Smart Connect.
