...
thumbconsole element add text --text A --x 0.72 --y 0.66 --text-color '#FFFFFF'
thumbconsole element set jump --keyboard Space --hide-integrated-label --light-fill '#7C3AED' --dark-fill '#C4B5FD' --shape circle --width 1.2 --height 1.2 --z-index 10
